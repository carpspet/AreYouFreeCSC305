...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ProfileAfterSignUp',
          path: '/profile',
          builder: (context, params) => const ProfileAfterSignUpWidget(),
        ),
        FFRoute(
          name: 'CalendarView',
          path: '/calendarView',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CalendarView')
              : CalendarViewWidget(
                  selectedDay: params.getParam(
                    'selectedDay',
                    ParamType.DateTime,
                  ),
                ),
        ...
        FFRoute(
          ...
          path: '/friendListPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'friendListPage')
