...
import 'friend_removed_model.dart';
export 'friend_removed_model.dart';

class FriendRemovedWidget extends StatefulWidget {
  const FriendRemovedWidget({super.key});
...
class _FriendRemovedWidgetState extends State<FriendRemovedWidget>
  ...
  late FriendRemovedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriendRemovedModel());
