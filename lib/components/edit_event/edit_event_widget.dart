...
class EditEventWidget extends StatefulWidget {
  ...
  final AppointmentsRecord? eventID;
...
class _EditEventWidgetState extends State<EditEventWidget> {
  ...
  void initState() {
    ...
    _model.eventDescTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.eventID?.eventDescription,
      'Description',
    ));
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                dateTimeFormat(
                                    "M/d h:mm a", widget.eventID!.eventTime!),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Lato',
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                dateTimeFormat(
                                    "M/d h:mm a", widget.eventID!.endTime!),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Lato',
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: valueOrDefault<Color>(
                                          widget.eventID?.color,
                                          const Color(0xFF5BE4FF),
                                        ),
                                        border: Border.all(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
              ...
              FFButtonWidget(
                onPressed: () async {
                  await widget.eventID!.reference
              ...
              FFButtonWidget(
                onPressed: () async {
                  await widget.eventID!.reference.delete();
