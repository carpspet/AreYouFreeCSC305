...
import '/components/friend_request_sent/friend_request_sent_widget.dart';
...
class AddFriendPageWidget extends StatefulWidget {
  const AddFriendPageWidget({super.key});

  @override
  State<AddFriendPageWidget> createState() => _AddFriendPageWidgetState();
}
...
class _AddFriendPageWidgetState extends State<AddFriendPageWidget>
  ...
  void initState() {
    ...
    _model.addFriendEmailTextController ??= TextEditingController();
    _model.addFriendEmailFocusNode ??= FocusNode();
                          ...
                          child: Column(
                            ...
                            children: [
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 8.0),
                                            child: Text(
                                              'Please enter the information below to add a friend',
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.addFriendEmailTextController,
                                  focusNode: _model.addFriendEmailFocusNode,
                                  autofocus: true,
                                  obscureText: false,
