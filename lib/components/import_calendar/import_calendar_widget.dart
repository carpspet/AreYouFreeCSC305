...
class ImportCalendarWidget extends StatefulWidget {
  const ImportCalendarWidget({super.key});

  @override
  State<ImportCalendarWidget> createState() => _ImportCalendarWidgetState();
}

class _ImportCalendarWidgetState extends State<ImportCalendarWidget> {
  late ImportCalendarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImportCalendarModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          await launchURL(
                              'https://support.google.com/calendar/?hl=en#topic=10509740');
                        },
                        child: Text(
