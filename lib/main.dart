...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = areYouFreeCSC305SecondVerFirebaseUserStream()
      ..listen((user) {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      title: 'AreYouFreeCSC305SecondVer',
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'CalendarView';
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'CalendarView': const CalendarViewWidget(),
